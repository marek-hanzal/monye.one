...
import {
	...
	type ITransactionKeywordRepositorySchemaEx
} from "@monye.one/transaction";
import {type PrismaClient} from "@monye.one/prisma";

export class BaseTransactionKeywordRepositoryEx<
    TRepositoryType extends TransactionKeywordSource["Type"]["Repository"] = TransactionKeywordSource["Type"]["Repository"]
> extends AbstractRepositoryEx<
    ITransactionKeywordRepositorySchemaEx["Schema"],
    TransactionKeywordSource["Schema"]["Repository"]
> {
	static inject = [
        $PrismaClient,
    ];
    ...
    constructor(
        ...
        super($TransactionKeywordRepository);
    }
 ...
 */
export const $leight_v0fmqpmov71b46dnwlhktavu = true;
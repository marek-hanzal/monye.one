...
import { type ISource, type ISourceSchema } from "@leight/source";
import {
...
export interface ITransactionImportService
    extends IImportService<ITransactionImport> {}
...
export interface ITransactionSourceSchema

import { type ISourceProps, Source } from "@leight/source-client";
import {
...
import { TransactionProvider, useTransactionSort } from "../context";

export interface ITransactionSourceProps
    extends ISourceProps<ITransactionSourceSchema> {}

...
} from "../Form/TransactionLabelBaseForm";
import {useTransactionQueryInvalidator} from "./useTransactionQueryInvalidator";
import {UseTransactionSourceQuery} from "./UseTransactionSourceQuery";
...
export const TransactionLabelTrpcForm: FC<ITransactionLabelTrpcFormProps> = ({onSuccess, onError, onSettled, ...props}) => {
    ...
    const mutation = UseTransactionSourceQuery.usePatchBy();
    const invalidator = useTransactionQueryInvalidator();
 ...
 */
export const $leight_sqiw19mx41wiedkulngspa7x = true;
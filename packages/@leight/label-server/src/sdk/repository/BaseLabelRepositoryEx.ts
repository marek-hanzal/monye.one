...
import {
	$LabelRepository,
	type LabelSource,
	type ILabelRepositorySchemaEx
} from "@leight/label";

export class BaseLabelRepositoryEx<
    TRepositoryType extends LabelSource["Type"]["Repository"] = LabelSource["Type"]["Repository"]
> extends AbstractRepositoryEx<
    ILabelRepositorySchemaEx["Schema"],
    LabelSource["Schema"]["Repository"]
> {
	static inject = [
        $PrismaClient,
    ];
 ...
 */
export const $leight_a39ssld0te1a64ugtv8s3j0y = true;
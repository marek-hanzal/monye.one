...
export class KeywordBasePrismaSource extends AbstractSourceEx<IKeywordPrismaSchemaType, IKeywordSourceSchemaType> {
    ...
    async runFetch({filter}: IKeywordSourceSchemaType["Query"]): Promise<IKeywordSourceSchemaType["Entity"]> {
    ...
    async runPatch({patch, filter}: ISource.IPatch<IKeywordSourceSchemaType>): Promise<IKeywordSourceSchemaType["Entity"]> {
 ...
 */
export const $leight_ib35iqryfiglldteofsnbnr6 = true;
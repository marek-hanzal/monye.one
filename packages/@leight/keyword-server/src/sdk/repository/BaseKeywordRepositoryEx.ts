...
import {
	$KeywordRepository,
	type KeywordSource,
	type IKeywordRepositorySchemaEx
} from "@leight/keyword";

export class BaseKeywordRepositoryEx<
    TRepositoryType extends KeywordSource["Type"]["Repository"] = KeywordSource["Type"]["Repository"]
> extends AbstractRepositoryEx<
    IKeywordRepositorySchemaEx["Schema"],
    KeywordSource["Schema"]["Repository"]
> {
	static inject = [
        $PrismaClient,
    ];
 ...
 */
export const $leight_zgud6l9sfva93abs37cz8imf = true;
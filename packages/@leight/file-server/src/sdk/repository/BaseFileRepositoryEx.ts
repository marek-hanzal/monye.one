...
import {
	$FileRepository,
	type FileSource,
	type IFileRepositorySchemaEx
} from "@leight/file";

export class BaseFileRepositoryEx<
    TRepositoryType extends FileSource["Type"]["Repository"] = FileSource["Type"]["Repository"]
> extends AbstractRepositoryEx<
    IFileRepositorySchemaEx["Schema"],
    FileSource["Schema"]["Repository"]
> {
	static inject = [
        $PrismaClient,
    ];
 ...
 */
export const $leight_b8fgurl295nxdpww9vobtb25 = true;
...
export class FileBasePrismaSource extends AbstractSourceEx<IFilePrismaSchemaType, IFileSourceSchemaType> {
    ...
    async runPatch({patch, filter}: ISource.IPatch<IFileSourceSchemaType>): Promise<IFileSourceSchemaType["Entity"]> {
    ...
    async runPatchBy({patch, filter}: ISource.IPatchBy<IFileSourceSchemaType>): Promise<unknown> {
 ...
 */
export const $leight_uc9q80g1rfv8as9hbtuunt8k = true;
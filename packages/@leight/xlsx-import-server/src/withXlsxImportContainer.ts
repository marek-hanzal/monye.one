...
import {$MetaService, $MetaServiceConfig, $TabService, $TranslationService, $XlsxImportService,} from "@leight/xlsx-import";
import {MetaService, TabService, TranslationService, XlsxImportService} from "./service";

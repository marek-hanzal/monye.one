...
export interface IUseUploadProps extends Pick<IUseChunkProps, "onStart" | "onError"> {
    ...
    onFinish?(props: IOnFinishProps & {
        file: IFileSourceType["Entity"]
    }): Promise<void>;
}

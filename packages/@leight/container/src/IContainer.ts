...
export interface IContainer {
    ...
    bindClass<T extends IContainer.Class>(key: IContainer.Key, value: T, options?: IContainer.Options.Class<T>): IContainer;

    bindFactory<T extends IContainer.Factory>(key: IContainer.Key, value: T, options?: IContainer.Options.Factory<T>): IContainer;
...
export namespace IContainer {
    ...
    export type Factory = FactoryValue;
